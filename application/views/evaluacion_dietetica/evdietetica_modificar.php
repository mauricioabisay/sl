...
<form action="<?php echo site_url();?>/evdietetica/modificar/<?php echo $id_evdietetica;?>" method="post" id="formulario" style="width:100%" target="contenido">
<input type="hidden" name="paciente" value="<?php echo $id_paciente;?>" />
<fieldset>
	<legend>Evaluaci&oacute;n Diet&eacute;tica</legend>		
	<?php $this->load->view('evaluacion_dietetica/extras/evaluacion_modificar_recordatorio');?>
	<?php $this->load->view('evaluacion_dietetica/extras/evaluacion_modificar_frecuencia_alimentos');?>
	<?php $this->load->view('evaluacion_dietetica/extras/evaluacion_modificar_historial');?>
	<?php $this->load->view('evaluacion_dietetica/extras/evaluacion_modificar_habitos');?>
	<?php $this->load->view('evaluacion_dietetica/extras/evaluacion_modificar_generales');?>
</fieldset>
