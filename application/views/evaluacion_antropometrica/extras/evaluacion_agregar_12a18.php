...
<fieldset>
	...
	<div class="lineal_eval"><label>Circ. Cintura:</label><input type="text" size="6" name="c_cintura" value="<?php echo set_value('c_cintura');?>" /><strong>cms.</strong></div>
	<div class="lineal_eval"><label>Circ. Cadera:</label><input type="text" size="6" name="c_cadera" value="<?php echo set_value('c_cadera');?>" /><strong>cms.</strong></div>
...
<fieldset>
	...
	<div id="ocultar" <?php echo (isset($embarazo))?'':'style="display: none;"'?>>
		<div class="lineal_eval">
			...
			<?php }else{?>
					<input type="text" size="6" name="peso_pre_gesta" value="<?php echo set_value('peso_pre_gesta',(isset($evaluacion)&&($evaluacion))?$evaluacion->peso:'');?>" /><strong>kgs.</strong>
			<?php }?>
		</div>
		<div class="lineal_eval">
			...
			<?php if(isset($embarazo)){?>
					<?php
						...
						$aux_intervalo = date_diff($aux_semana_ini,new DateTime);
		...
		<div class="lineal_eval">
			...
			<?php if(isset($embarazo)){?>
					<input type="text" size="5"  name="fondo_uterino"  onchange='calcula()' value="<?php echo set_value('fondo_uterino'/*,$embarazo->semana_gesta*/);?>" /><strong>cms.</strong>
			<?php }else{?>
