...
<div id="laboratorio_resultados">
	<div class="lineal">
		...
		<?php $fecha_l = DateTime::createFromFormat('Y-m-d',$laboratorio->fecha_laboratorio);echo ($fecha_l)?$fecha_l->format('d-m-Y'):'';?>
	</div>
	<div class="lineal">
		<label>Fecha de captura (Fecha en que el paciente proporcionó los resultados de los estudios):</label>
		<?php $fecha_c = DateTime::createFromFormat('Y-m-d',$laboratorio->fecha_captura);echo ($fecha_c)?$fecha_c->format('d-m-Y'):'';?>
	</div>
	<table class="listado">
		<thead>
			<tr>
