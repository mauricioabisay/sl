...
<form action="<?php echo site_url()?>/laboratorio/agregar/<?php echo $id_paciente;?>" method="post" id="formulario" name="formulario" target="contenido" style="width: 100%">
<input type="hidden" name="paciente" value="<?php echo $id_paciente;?>" />
	<fieldset>
		<legend>Laboratorio</legend>
		<div class="columnaizq" style="width: 45%">
			<?php $this->load->view('laboratorio/extras/laboratorio_agregar_solicitud');?>	
		</div>
		<div class="columnader">
			<?php $this->load->view('laboratorio/extras/laboratorio_agregar_recepcion');?>
		</div>
	</fieldset>
