...
?>
	<form action="<?php echo site_url();?>/comentario/agregar/<?php echo $id_paciente;?>" method="post" id="formulario" style="width:100%;margin-bottom:0;padding-bottom:0">
	...
	<fieldset>
		...
		<textarea name="comentario" rows="4" style="width:98%"><?php echo set_value('comentario',($comentario)?$comentario->comentario:'');?></textarea>
	</fieldset>
	<div class="botones" align="center" style="margin-bottom:0;padding-bottom:0">
