...
?>
	<form method="post" action="<?php echo site_url();?>/antecedentes_patologicos/agregar/<?php echo $id_paciente;?> " name="formulario" id="formulario" style="width: 100%">
		<input type="hidden" name="paciente" value="<?php echo $id_paciente?>" />
		<fieldset>
			<legend>Antecedentes Patol&oacute;gicos</legend>
			<?php $this->load->view('antecedentes_patologicos/antecedentes_patologicos_hereditarios');?>	
			<fieldset>
